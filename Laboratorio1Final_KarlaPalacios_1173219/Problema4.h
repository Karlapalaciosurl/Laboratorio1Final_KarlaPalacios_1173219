...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// btnRegresar
			// 
			this->btnRegresar->Location = System::Drawing::Point(148, 192);
			...
			this->btnRegresar->Click += gcnew System::EventHandler(this, &Problema4::btnRegresar_Click);
			// 
			// Problema4
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(392, 227);
